...
class CzlowiekDzieciFactoryTest {
  ...
  void dzieciPowinnyBycNiesortowane() {
    ...
    rodzic.dodajDziecko(dziecko3);
    assertAll(
        () -> assertEquals(true, rodzic.getDzieci().contains(dziecko1)),
        () -> assertEquals(true, rodzic.getDzieci().contains(dziecko2)),
        () -> assertEquals(true, rodzic.getDzieci().contains(dziecko3)));
  }
}